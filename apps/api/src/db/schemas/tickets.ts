...
export const tickets = pgTable(
  "tickets",
  {
    ...
    requeuedFromTicketId: uuid("requeued_from_ticket_id"),
  ...
  (table) => [
    ...
    // fast dedup lookup: does this email already have an active ticket in this queue?
    index("tickets_queue_email_status_idx").on(
      table.queueId,
      table.customerEmail,
      table.status,
    ),
